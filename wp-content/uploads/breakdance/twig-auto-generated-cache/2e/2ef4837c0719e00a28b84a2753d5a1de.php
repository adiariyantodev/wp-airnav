...
/* fe5583665ac28f325dcae9420f96e767ee85a6c8 */
class __TwigTemplate_2f6b842e26bf8ca846f113e1e412142e extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "
          ";
        // line 2
        $macros["macros"] = $this->macros["macros"] = $this->loadTemplate("macros.twig", "fe5583665ac28f325dcae9420f96e767ee85a6c8", 2)->unwrap();
        // line 3
        echo "
          ";
        // line 4
...
>
        ...
        <input
            ...
            id=\"gmwsaz-1\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-1\">Mendengarkan</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            id=\"gmwsaz-2\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-2\">Mendengarkan</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            id=\"gmwsaz-3\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-3\">Mencatat</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            id=\"gmwsaz-4\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-4\">Salinan Informasi (Softcopy)</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            id=\"gmwsaz-5\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-5\">Salinan Informasi (Hardcopy)</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            checked
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-6\">Melihat</label>
    </div>
...
<footer class=\"breakdance-form-field breakdance-form-footer\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["step"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 343);
            echo "\">
            ";
            // line 344
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", true, true, false, 344) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 344)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 344)) : ("Previous Step")), false, "breakdance-form-button breakdance-form-button__previous-step hidden", ($context["previousStepButtonDesign"] ?? null), "secondary", false, false, "step.next_button_text"], 344, $context, $this->getSourceContext());
            echo "
            ";
            // line 345
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", true, true, false, 345) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 345)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 345)) : ("Next Step")), false, "breakdance-form-button breakdance-form-button__next-step hidden", ($context["nextStepButtonDesign"] ?? null), "primary", false, false, "step.next_button_text"], 345, $context, $this->getSourceContext());
            echo "
        </div>
    ";
            ++$context['loop']['index0'];
        ...
        // line 348
        echo "    ";
        echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(($context["submitButtonText"]) ?? ("Submit")), false, "breakdance-form-button breakdance-form-button__submit", ($context["submitButtonDesign"] ?? null), "primary", ($context["submitButtonId"] ?? null), true, "content.form.submit_text"], 348, $context, $this->getSourceContext());
        echo "
  ...
  ";
    ...
    {
        return "fe5583665ac28f325dcae9420f96e767ee85a6c8";
    }
    ...
    {
        return array (  513 => 353,  504 => 348,  487 => 345,  483 => 344,  478 => 343,  461 => 342,  455 => 339,  149 => 35,  144 => 32,  128 => 29,  122 => 27,  120 => 26,  117 => 25,  111 => 23,  105 => 21,  103 => 20,  97 => 18,  80 => 17,  76 => 15,  74 => 14,  70 => 13,  56 => 12,  53 => 11,  51 => 9,  50 => 8,  49 => 6,  47 => 5,  45 => 4,  42 => 3,  40 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "fe5583665ac28f325dcae9420f96e767ee85a6c8", "");
    }
}
