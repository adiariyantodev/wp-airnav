...
/* 18e5a6bb49f606d4f8d4b73f092c192758eee8e6 */
class __TwigTemplate_c5426c04e899faf3cfcd8f807ed7dabb extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "
          ";
        // line 2
        $macros["macros"] = $this->macros["macros"] = $this->loadTemplate("macros.twig", "18e5a6bb49f606d4f8d4b73f092c192758eee8e6", 2)->unwrap();
        // line 3
        echo "
          ";
        // line 4
...
>
        ...
        <input
            ...
            id=\"gmwsaz-1\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-1\">Salinan Informasi (Softcopy)</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            id=\"gmwsaz-2\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-2\">Salinan Informasi (Softcopy)</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            id=\"gmwsaz-3\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-3\">Salinan Informasi (Hardcopy)</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            checked
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-4\">Melihat</label>
    </div>
...
<footer class=\"breakdance-form-field breakdance-form-footer\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["step"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 323);
            echo "\">
            ";
            // line 324
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", true, true, false, 324) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 324)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 324)) : ("Previous Step")), false, "breakdance-form-button breakdance-form-button__previous-step hidden", ($context["previousStepButtonDesign"] ?? null), "secondary", false, false, "step.next_button_text"], 324, $context, $this->getSourceContext());
            echo "
            ";
            // line 325
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", true, true, false, 325) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 325)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 325)) : ("Next Step")), false, "breakdance-form-button breakdance-form-button__next-step hidden", ($context["nextStepButtonDesign"] ?? null), "primary", false, false, "step.next_button_text"], 325, $context, $this->getSourceContext());
            echo "
        </div>
    ";
            ++$context['loop']['index0'];
        ...
        // line 328
        echo "    ";
        echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(($context["submitButtonText"]) ?? ("Submit")), false, "breakdance-form-button breakdance-form-button__submit", ($context["submitButtonDesign"] ?? null), "primary", ($context["submitButtonId"] ?? null), true, "content.form.submit_text"], 328, $context, $this->getSourceContext());
        echo "
  ...
  ";
    ...
    {
        return "18e5a6bb49f606d4f8d4b73f092c192758eee8e6";
    }
    ...
    {
        return array (  493 => 333,  484 => 328,  467 => 325,  463 => 324,  458 => 323,  441 => 322,  435 => 319,  149 => 35,  144 => 32,  128 => 29,  122 => 27,  120 => 26,  117 => 25,  111 => 23,  105 => 21,  103 => 20,  97 => 18,  80 => 17,  76 => 15,  74 => 14,  70 => 13,  56 => 12,  53 => 11,  51 => 9,  50 => 8,  49 => 6,  47 => 5,  45 => 4,  42 => 3,  40 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "18e5a6bb49f606d4f8d4b73f092c192758eee8e6", "");
    }
}
