...
/* 02d4b4d725e09cfd1d93d3d9e387ad470245816c */
class __TwigTemplate_2bc2e78c0e2c965cc56e0a55d1793307 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "
          ";
        // line 2
        $macros["macros"] = $this->macros["macros"] = $this->loadTemplate("macros.twig", "02d4b4d725e09cfd1d93d3d9e387ad470245816c", 2)->unwrap();
        // line 3
        echo "
          ";
        // line 4
    ...
    <div class=\"breakdance-form-checkbox\">
        <input
            ...
            id=\"gmwsaz-2\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-2\">Mencatat</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            id=\"gmwsaz-3\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-3\">Salinan Informasi (Softcopy)</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            id=\"gmwsaz-4\"
                    ...
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-4\">Salinan Informasi (Hardcopy)</label>
    </div>
    <div class=\"breakdance-form-checkbox\">
        <input
            type=\"checkbox\"
            ...
            checked
                    >
        <label class=\"breakdance-form-checkbox__text\" for=\"gmwsaz-5\">Melihat</label>
    </div>
...
<footer class=\"breakdance-form-field breakdance-form-footer\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["step"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 333);
            echo "\">
            ";
            // line 334
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", true, true, false, 334) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 334)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 334)) : ("Previous Step")), false, "breakdance-form-button breakdance-form-button__previous-step hidden", ($context["previousStepButtonDesign"] ?? null), "secondary", false, false, "step.next_button_text"], 334, $context, $this->getSourceContext());
            echo "
            ";
            // line 335
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", true, true, false, 335) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 335)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 335)) : ("Next Step")), false, "breakdance-form-button breakdance-form-button__next-step hidden", ($context["nextStepButtonDesign"] ?? null), "primary", false, false, "step.next_button_text"], 335, $context, $this->getSourceContext());
            echo "
        </div>
    ";
            ++$context['loop']['index0'];
        ...
        // line 338
        echo "    ";
        echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(($context["submitButtonText"]) ?? ("Submit")), false, "breakdance-form-button breakdance-form-button__submit", ($context["submitButtonDesign"] ?? null), "primary", ($context["submitButtonId"] ?? null), true, "content.form.submit_text"], 338, $context, $this->getSourceContext());
        echo "
  ...
  ";
    ...
    {
        return "02d4b4d725e09cfd1d93d3d9e387ad470245816c";
    }
    ...
    {
        return array (  503 => 343,  494 => 338,  477 => 335,  473 => 334,  468 => 333,  451 => 332,  445 => 329,  149 => 35,  144 => 32,  128 => 29,  122 => 27,  120 => 26,  117 => 25,  111 => 23,  105 => 21,  103 => 20,  97 => 18,  80 => 17,  76 => 15,  74 => 14,  70 => 13,  56 => 12,  53 => 11,  51 => 9,  50 => 8,  49 => 6,  47 => 5,  45 => 4,  42 => 3,  40 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "02d4b4d725e09cfd1d93d3d9e387ad470245816c", "");
    }
}
