...
<div class="wpsr-fm-chat-btn-wrapper">
    <div class="wpsr-fm-btn-icon">
            <?php if ( $settings['channels'] && sizeof($settings['channels']) === 1){
                ...
                ?>
                <?php if (!($channelName === 'whatsapp') || !$hasPrefilledMessage) { ?>
                    <a role="button"
                ...
                <?php } else { ?>
                    <div class="wpsr-whatsapp-input-container" data-phone-number="<?php echo esc_attr($phoneNumber); ?>" <?php echo ($whatsappBgColor) ? 'style="' . esc_attr($whatsappBgColor) . '"' : ''; ?>>
                        <div class="wpsr-whatsapp-input-container-inner">
                            <input type="text" placeholder="Type a message" class="wpsr-whatsapp-input" <?php echo ($inputTextColor) ? 'style="' . esc_attr($inputTextColor) . '"' : ''; ?>>
                        </div>
                        <button class="wpsr-whatsapp-send-button" <?php echo ($sendBtnBgColor) ? 'style="' . esc_attr($sendBtnBgColor) . '"' : ''; ?>>
                            <svg <?php echo ($sendBtnIconColor) ? 'style="' . esc_attr($sendBtnIconColor) . '"' : ''; ?> viewBox="0 0 24 24" x="0px" y="0px" class="wpsr-whatsapp-send-button-icon">
                                <title>send</title>
