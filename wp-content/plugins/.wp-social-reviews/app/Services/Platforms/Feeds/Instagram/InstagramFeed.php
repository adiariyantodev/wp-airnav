        ...
        if (!empty($args) && isset($args['api_type']) && $access_token) {
            ...
            if ($api_type === 'personal') {
                ...
                if ($endpoint === 'verification_header' || $endpoint === 'header') {
                    //verification
                    $apiUrl = "https://graph.instagram.com/v21.0/me?fields=user_id,username,account_type,profile_picture_url,followers_count,follows_count,media_count&access_token=" . $access_token;
                }
            }
            return $apiUrl;
        }
